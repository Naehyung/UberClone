...
const GOOGLE_MAPS_APIKEY = "AIzaSyBO262gv9qxp01ep4aFyaWp6mRYHFEAV60"
        ...
        if(order&&order.isFinished ) {
            return (
                <View style={{alignItems: 'center'}}>
                    <View style={{flexDirection: 'row', alignItems: 'center', backgroundColor: "#cb1a1a", width: 200,}}>
